-- ============================================================
-- SCORING — Révision prix + malus aides
-- Prix     : 500 pts si exact · −50 pts par CHF d'écart (min 0)
-- Malus    : −200 pts par aide utilisée (appliqué sur le total)
-- ============================================================
...
begin
  ...
  loop
    ...
    -- 4. PRIX (500 pts si exact · −50 pts par CHF d'écart, min 0)
    ...
    -- 9. MALUS AIDES (−200 pts par aide utilisée, min 0 au total)
