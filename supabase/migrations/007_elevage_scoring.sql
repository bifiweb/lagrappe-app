-- ============================================================
-- SCORING — Ajout élevage + révision barème
-- Élevage  : 300 pts si juste · 100 pts sinon (NOUVEAU)
-- Millésime : 500 pts si juste · 100 pts sinon (était 400)
-- Région    : 500 pts si juste · 100 pts sinon (était 1000)
-- ============================================================

-- Nouvelle colonne pts_elevage dans tastings
...
begin
  ...
  loop
    ...
    -- 2. ARÔMES (300 pts × nb joueurs même arôme + 300 si officiel)
    v_pts_aromes := 0;
    ...
    -- 4. PRIX (1000 si exact, -100 pts/CHF d'écart, min 0)
    ...
    -- 5. MILLÉSIME (500 si correct, 100 sinon)
    ...
    -- 7. RÉGION (500 si correct, 100 sinon)
    ...
    -- 8. ÉLEVAGE (300 si correct, 100 sinon)
