...
export const WINE_CONTENT: Record<WineType, WineContent> = {
  rouge: {
    ...
    bouche: ['Très léger', 'Léger', 'Souple équilibré', 'Puissant', 'Très puissant'],
  ...
  blanc: {
    ...
    bouche: ['Acidité vive', 'Acidité', 'Équilibre', 'Gras', 'Très gras onctueux'],
...
export const SCORING = {
  ROBE_CORRECT: 500,
  ROBE_WRONG: 200,
  AROME_PER_PLAYER: 200,
  AROME_GRAPPISTE_BONUS: 200,
  BOUCHE_CORRECT: 500,
  BOUCHE_WRONG: 200,
  PRIX_MAX: 500,
  PRIX_PER_CHF: 50,
  MILLESIME_MAX: 500,
  MILLESIME_PER_YEAR: 50,
  CEPAGE_CORRECT: 1500,
  CEPAGE_WRONG: 300,
  REGION_CORRECT: 500,
  REGION_WRONG: 100,
